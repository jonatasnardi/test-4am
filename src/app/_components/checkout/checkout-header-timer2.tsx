  ...
  return (
    <>
      <div className="w-full">
        <div className="flex w-full relative">
          ...
          <div className="flex w-full justify-center z-10 py-4">
            <div className="flex w-full max-w-[1170px] px-4 flex-col lg:flex-row">
      ...
      <div className="sticky top-0 z-50 w-full bg-gradient-to-r from-[#53a1ea] to-[#365bf2]">
        <div className="flex w-full max-w-[1170px] mx-auto justify-between items-center px-4 text-[18px] sm:text-[20px] text-white">
