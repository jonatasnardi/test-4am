  ...
  return (
    <>
      <HandleSessionStart
        ...
        product={product}
      />
      <div className="flex  w-full relative flex-col items-center bg-[#FFFFFF]">
        <div id="payment-container" />
        <div className="flex w-full max-w-[1170px] pb-12 flex-wrap">
          <div className="flex flex-col w-full  lg:w-1/2 lg:py-8 pt-4 sm:pt-8 pb-4">
            <div className="bg-[#fff1af] rounded-[7px] p-4 px-2 md:px-14 rounded-lg flex ml-4 mr-4 md:ml-0 md:mr-0">
              <DiscountBar
                product={product.product}
                info={info}
                couponActive={customerInfo.couponActive}
          ...
          <div className="flex flex-col  w-full  lg:w-1/2 lg:py-8">
          </div>
        </div>
        <CheckoutCouponPop
          info={info}
